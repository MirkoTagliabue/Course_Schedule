...
è utile per capire se in un ciclo for o while ho scorso tutta la lista (se il puntatore successivo al nodo in esame è uguale al puntatore lista, allora
ho scorso tutta la lista ed il nodo in esame è l'ultimo della linked list).
<br>
<div align="center">
...
del nodo k. Le liste forward star sono state implementata come linked list circolari bidirezionali con sentinella.  
