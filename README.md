...
gli N esami universitari ed $\{0, 1, N \} \subseteq \mathbb{N}$.  
...
Le liste sono state implementate come liste cicliche bidirezionali con sentinella.  
...
necessario far scorrere tutti i k-1 puntatori "succ" precedenti, a differenza dei vettori dove l'accesso all'elemento k-esimo avviene in tempo $\theta(1)$.
